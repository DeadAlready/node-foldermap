...
var props = ['_path','_name','_ext','_type','_content','_read','_write','_base'];
...
function _mapInfo(filePath, stats){
  ...
  if(type === 'file'){
    Object.defineProperties(info, {
      ...
      '_read':{
        get: function(){ return fs.createReadStream(filePath); }
      },
      '_write':{
        get: function(){ return fs.createWriteStream(filePath); }
      }
    });
  }
